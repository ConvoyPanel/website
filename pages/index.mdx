---
title: Convoy – Server Control Panel
---

import { Feature, Features } from '@/components/elements/features'
import cn from 'clsx'
import { motion } from 'framer-motion'
import Image from 'next/image'
import Link from 'next/link'
import { useState } from 'react'
import docsCardDark from '../public/favicon.ico'
import docsCard from '../public/assets/images/panel.png'
...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Power Your Hosting<br className='sm:block hidden'/>Business With Convoy</h1>
    <p className="subtitle mt-3">Modern and sleek. Finally a panel you will love.</p>
  ...
  <style jsx>{`
    ...
    :global(#highlighting-card) {
      min-height: 300px;
      background-image: linear-gradient(to top, transparent, #fff 50%), url(/assets/images/syntax-highlighting.svg);
      background-size: 634px;
      background-position: -6px calc(100% + 4px);
      background-repeat: no-repeat;
    }
    :global(.dark #highlighting-card) {
      background-image: linear-gradient(to top, transparent, #202020 50%), url(/assets/images/syntax-highlighting.svg);
    }
    ...
    <div className="content-container">
      <Features>
        <Feature index={0} large centered id="docs-card">
          ...
          <h3>Your dashboard, <br className="show-on-mobile"/>overhauled.</h3>
        </Feature>
        <Feature index={1} centered className="card-with-border" href="/docs/guide/image">
          <div className="h-full flex flex-col justify-between">
            <h3>Pricing that scales with <br className="show-on-mobile"/> your business.</h3>
            <p className='text-left mb-8'>Convoy Panel is priced at 6 USD per node per month. If you are a non-profit, you can reach out to <a href='mailto:eric@performave.com'>us</a> for pricing exemptions.</p>
            <div className='grid place-items-center h-72'>
              <div className='flex'><p className='text-xl'>$</p><p className='text-[12rem] font-bold !mt-0 price-label !leading-[1.15]'>6</p><p className='absolute right-14 self-end mb-7'>/node/month</p></div>
            </div>
          </div>
        </Feature>
        <Feature index={2} id="highlighting-card" href="https://github.com/convoypanel/panel">
          <h3>Source code <br className="show-on-mobile"/> public for everyone to see.</h3>
          <p>Need more than what Convoy offers? Fork our [repository](https://github.com/convoypanel/panel) and edit to suit your needs.</p>
        </Feature>

        <Feature index={3} centered className="feat-darkmode" style={{
          display: 'flex',
          alignItems: 'center',
